...
public class Config {
    ...
    public static final boolean ENABLE_TV = true;
    public static final boolean ENABLE_LTE = false;
    ...
    public static final String SEED_NODE_LTE = "http://api.decentspec.org:5001";
